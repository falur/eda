...
Использование:
  ...
  eda update   — дополнить недостающие настройки и обновить текущий проект
  eda update-all [dir] — сохранить конфиги или настроить общий и обновить проекты внутри dir

...
| `eda-plan-polish` | Полирует уже готовый план до оценки 95/100 или заданного порога. Сначала основной агент оценивает план; если оценка ниже порога, запускает три изолированных параллельных plan-polish агента на быстрой, кодовой и флагманской моделях, как `eda-plan`; анализирует их предложения, правит только файл плана и повторяет цикл до качества или лимита | `docs/plans/` |

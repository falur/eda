...
Добавляй finding только если план обязательно нужно исправить для устранения доказанного пути нарушения или существенной неоднозначности защитного поведения. Не предлагай абстрактное усиление, дополнительные пояснения и стилистические улучшения; если замечание можно безопасно проигнорировать, верни `findings: []`.

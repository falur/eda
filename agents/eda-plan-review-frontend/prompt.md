...
Добавляй находку только если план обязательно нужно исправить: без правки пользовательский сценарий останется сломанным, существенно неоднозначным или потребует нового решения при реализации. Не требуй перечислять состояния, которые однозначно следуют из существующего компонента или не относятся к задаче; если замечание можно безопасно проигнорировать, верни `находки: []`.

...
Добавляй finding только если план обязательно нужно исправить для устранения доказанного нагрузочного риска или существенной неоднозначности реализации. Не предлагай дополнительные пояснения, полноту ради полноты и стилистические улучшения; если замечание можно безопасно проигнорировать, верни `findings: []`.

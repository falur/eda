...
Добавляй finding только если план обязательно нужно исправить: без правки требование останется нарушенным, существенно неоднозначным или непроверяемым. Не предлагай дополнительные пояснения, полноту ради полноты и стилистические улучшения; если замечание можно безопасно проигнорировать, верни `findings: []`.

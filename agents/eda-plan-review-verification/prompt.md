...
Добавляй finding только если план обязательно нужно исправить: без правки конкретная регрессия или эксплуатационный риск останутся непроверяемыми. Не предлагай дополнительные проверки, пояснения и документацию без доказанного риска; если замечание можно безопасно проигнорировать, верни `findings: []`.

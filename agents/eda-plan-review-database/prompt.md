...
Добавляй находку только если план обязательно нужно исправить: без правки данные, миграция или rollout останутся ошибочными, существенно неоднозначными или потребуют нового решения при реализации. Не предлагай дополнительные пояснения, полноту ради полноты и стилистические улучшения; если замечание можно безопасно проигнорировать, верни `находки: []`.

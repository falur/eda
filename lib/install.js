...
const FLOW_META_MODEL_CHOICES = ['fable', 'haiku', 'sonnet', 'opus'];
...
function migrateSettingsContent(content) {
  ...
  transfer('flow.metaModel', flow.meta_model, oneOf(FLOW_META_MODEL_CHOICES), value => { settings.flow.metaModel = value; });
...
flow:
  ...
  meta_model: ${flow.metaModel ?? DEFAULT_FLOW.metaModel}
  plan_review:

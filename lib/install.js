...
const PLAN_REVIEW_AGENT_DEFINITIONS = [
  ...
  {
    key: 'previous',
    description: 'Проверяет закрытие находок предыдущей связанной итерации plan-review.',
...
plan-review:
  # План готов только без открытых находок и при score не ниже этого порога.
  # 1..100

...
`docs/rules.md`, `docs/arch.md` (если есть) — прочитай и строго следуй им. Сам файл ревью. Если ревью ссылается на план/research — прочитай и их.
